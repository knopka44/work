...
def driver():
    ...
    driver = webdriver.Chrome(executable_path='https://github.com/agrestvaleria/homework/blob/c7699eeac3b1d3ccae5b63f41af6ccc06f0076fb/chromedriver', options=driver_options)
